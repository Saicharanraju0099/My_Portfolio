        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Extracting actionable insights from complex datasets. Processing and cleaning data for statistical analysis, feature engineering, and predictive modeling.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Building dynamic, stakeholder-ready business intelligence dashboards to communicate KPIs, revenue trends, and performance variance.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">Business Reporting</div>
              </div>
              <div className="what-arrow"></div>
            </div>
          </div>
